...
* **Audio Coaching:** Audio coaching is generated using Gemini Text-to-Speech, enabling hands-free corrections during training. 
...
Concepts such as total daily energy expenditure are modeled using standard equations such as:
